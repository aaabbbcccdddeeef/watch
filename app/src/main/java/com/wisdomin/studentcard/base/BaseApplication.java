...
import com.wisdomin.studentcard.broadcast.BatteryBroadcastReceiver;
import com.wisdomin.studentcard.broadcast.BroadcastConstant;
import com.wisdomin.studentcard.broadcast.CallActiveReceiver;
...
import com.wisdomin.studentcard.broadcast.BroadcastReceiverInCall;
import com.wisdomin.studentcard.broadcast.TimeTickReceiver;
import com.wisdomin.studentcard.service.ServerService;
import com.wisdomin.studentcard.observer.CallLogObserver;
import com.wisdomin.studentcard.observer.CallTimeObserver;
...
//                TextToSpeechUtils.getInstance(mContext,"通知，" + smsMessageReceive.getMessage(), TextToSpeech.QUEUE_FLUSH, null);
    ...
    private void initBrocastReciver() {
        ...
        intentFilter1.addAction("com.wisdomin.studentcard.call.active");
